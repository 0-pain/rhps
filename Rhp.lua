...
ControllerAll = false
local ListSudos ={Sudo_Id,1150883146,5364985653}  
...
elseif tonumber(msg.sender.user_id) == 5364985653 then
...
-- download('https://raw.githubusercontent.com/rhpsaz77/rhps/main/Rhp.lua','Rhp.lua')
...
local m = "https://t.me/rhpmusic/"..Rrr..""
keyboard = {} 
keyboard.inline_keyboard = {
{
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/rhpmusic/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. ChatId .. '&photo=https://t.me/photorhp/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end

if text == "انمي" or text == "افتار" then
local t = "‎تم اختيار افتار لكِ"
Num = math.random(2,781)
local Texting = {Num}
local Rrr = Texting[math.random(#Texting)]
local m = "https://t.me/animerhp/"..Rrr..""
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مره اخرى', callback_data=msg.sender.user_id.."/avta"},
...
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. ChatId .. '&photo=https://t.me/animerhp/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
if #list ~= 0 then
local rhpsa = list[math.random(#list)]
return LuaTele.sendText(msg_chat_id,msg_id,rhpsa)
end
end
end
...
rhpsa = Redis:get(TheRhp.."nool:flotysb"..msg.sender.user_id) or 0
if UserInfo.username then
UserInfousername = '[' ..UserInfo.first_name..'](t.me/'..UserInfo.username..')'
else
UserInfousername = '[' ..UserInfo.first_name..'](tg://user?id='..UserId..')'
...
if text == "امثله" then
if Redis:get(TheRhp.."Rhp:Status:Games"..msg.chat_id) then
rhpsa = {"سبقني","يشويه","مجرب","مقصه","يثمنك","عون","بعين","الكذب","غبن","حلاله","الدحه","الطير","ونصيب","فار","طيعه","فانوس","محبته","معه","مخابر","نخله","الدله","السواهي","ثور","مستعجل","قصيره","المنقوشه","حليمه","عبوديه","علينا","جاره","يشبع","بنا","جيعانه"};
local time = os.time()
Redis:set(TheRhp.."Rhp:Game:Time"..msg.chat_id,time)
name = rhpsa[math.random(#rhpsa)]
...
reply_markup = {
inline_keyboard ={
{{text ="Source", url= "https://t.me/cen3d"}},
}
},
},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ',url='http://t.me/cen3d'}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'sᴏᴜʀᴄʀ',url='http://t.me/cen3d'}},}
