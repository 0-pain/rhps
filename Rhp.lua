...
local N = (Redis:get(TheRhp.."Rhp:Name:Bot") or "سلفر")
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/iiwiw'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ⇜  عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
data = {
{
{text = 'Dev', url = 't.me/iiwiw'}, 
},
{
{text = 'ch', url = 't.me/cen3d'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[- أهلاً بك في سورس سلفر ..
